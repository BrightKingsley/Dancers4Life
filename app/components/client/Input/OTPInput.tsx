...
const CustomOtpInput = ({
  ...
  return (
    <div>
      <div>
        <div className="w-full flex flex-row justify-center items-center gap-[12px] md:gap-[24px]">
          {valueItems.map((digit, index) => (
            <input
              ...
              {...otherProps}
              className="outline-none caret-incoverGreen rounded-[8px] border-[1px] md:border-[2px] text-center border-[#7B7B7B80] focus:border-incoverGreen h-[40px] md:h-[52px] w-[40px] md:w-[52px] valid:background-[#F8FBFA] text-primary"
            />
          ))}
        </div>
      </div>
